...
export const queuePeekMeta: AlgorithmMeta = {
  id: "queue-peek",
  name: "Peek",
  category: "Queues",
  description: "Reads the element at the front of the queue without removing it.",
...
export function generateQueuePeekSteps(): VisualizationStep[] {
  ...
  addStep(1, "demo_queue_peek() started.", "Initialize array and variables.", {}, false, { arr: "None", capacity: "None", front: "None", rear: "None", result: "None" });
  ...
  addStep(11, `return arr[front]`, `Peek successful. The front element is ${returnValue}.`, { [front]: "found" });
