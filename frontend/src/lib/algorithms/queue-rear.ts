...
export function generateQueueRearSteps(): VisualizationStep[] {
  ...
  addStep(1, "demo_queue_rear() started.", "Initialize array and variables.", {}, false, { arr: "None", capacity: "None", front: "None", rear: "None", result: "None" });
  ...
  returnValue = String(currentQueue[rear]);
  addStep(11, `return arr[rear]`, `Read successful. The rear element is ${returnValue}.`, { [rear]: "found" });
