...
export function generateStackIsFullSteps(): VisualizationStep[] {
  ...
  addStep(1, "demo_stack_isfull() started.", "Initialize array and variables.", {}, false, { arr: "None", capacity: "None", top: "None", result: "None" });
  addStep(2, "arr = [12, 34, 56, 78, 90]", "Array initialized full.", {}, false, { capacity: "None", top: "None", result: "None" });
  addStep(3, "capacity = 5", "Capacity set to 5.", {}, false, { top: "None", result: "None" });
  addStep(4, "top = 4", "Top pointer initialized to 4.", {}, false, { result: "None" });

  returnValue = "True";
  addStep(6, `return top == capacity - 1`, `4 == 4 evaluates to True. Stack is full.`, { [top]: "found" });
